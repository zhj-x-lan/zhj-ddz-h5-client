cc.Class({
    ...
    onLoad: function () {
        ...
        this.node.on('game_peng_rec',function(data){
            self.onPengGangChanged(data.detail);
        });
        ...
        this.node.on('game_gang_rec', function (data) {
            self.onPengGangChanged(data.detail);
        });


        /* this.node.on('game_begin',function(data){
            console.log('居然收到了game_begin()..........消息 ============================= ');
            self.onGameBein();
        }); */
        
        this.node.on('game_reset', function (data) {
            self.hideAllSides();
        });
