cc.Class({
    ...
    onLoad: function () {
        ...
        // registEvent('onGameAllScore',this,this.AddSumScore);
    },
    onEnable: function () {
        if (GameData.joiners) {
    ...
    onDestroy: function () {
        ...
        // unregistEvent('onGameScore', this, this.ShowPlayerScoreItme);
        // unregistEvent('onGameAllScore',this,this.AddSumScore);
    },
